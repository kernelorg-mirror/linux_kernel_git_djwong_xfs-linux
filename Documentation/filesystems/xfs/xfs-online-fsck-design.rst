...
expose XFS-specific filesystem details to a special userspace daemon without
cluttering up fanotify's userspace ABI.
Normal userpace programs are not expected to subscribe to the XFS events;
instead, they should subscribe to the generic events provided by fanotify.
