		  ...
		  const char *fmt, ...)
{
	...
	fserror_report_metadata(sb, error ? error : EFSCORRUPTED);
			...
			const char *fmt, ...)
{
	...
	fserror_report_filemeta(inode, error ? error : EFSCORRUPTED);
		       ...
		       const char *fmt, ...)
{
	...
	fserror_report_filemeta(inode, EFSCORRUPTED);
		      ...
		      unsigned int line, int errno)
{
	...
	fserror_report_metadata(sb, errno ? errno : EFSCORRUPTED);
