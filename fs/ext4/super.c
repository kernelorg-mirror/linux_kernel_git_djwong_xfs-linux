		  ...
		  const char *fmt, ...)
{
	...
	fserror_report_metadata(sb, GFP_ATOMIC, error ? error : EFSCORRUPTED);
			...
			const char *fmt, ...)
{
	...
	fserror_report_file_metadata(inode, GFP_ATOMIC,
		       ...
		       const char *fmt, ...)
{
	...
	fserror_report_file_metadata(inode, GFP_ATOMIC, EFSCORRUPTED);
		      ...
		      unsigned int line, int errno)
{
	...
	fserror_report_metadata(sb, GFP_ATOMIC, errno ? errno : EFSCORRUPTED);
