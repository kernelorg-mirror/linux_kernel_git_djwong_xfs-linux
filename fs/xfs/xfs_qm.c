	...
	struct xfs_mount	*mp)
{
	...
	/*
	 * Walk all the inodes to record quota counts, then flush the dquots
	 * more efficiently via the buffer list.
	 *
	 * We can get an error if we couldn't do a dquot allocation inside
