...
#define XFS_EXCHRANGE_UPD_CMTIME1	(1ULL << 63)
#define XFS_EXCHRANGE_UPD_CMTIME2	(1ULL << 62)

/* Freshness check required */
#define XFS_EXCHRANGE_CHECK_FRESH2	(1ULL << 61)

#define XFS_EXCHRANGE_PRIVATE_FLAGS	(XFS_EXCHRANGE_UPD_CMTIME1 | \
					 XFS_EXCHRANGE_UPD_CMTIME2 | \
					 XFS_EXCHRANGE_CHECK_FRESH2)
