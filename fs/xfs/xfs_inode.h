...
bool xfs_inode_is_alloc_unit_aligned(struct xfs_inode *ip, loff_t pos,
		long long int len);

/*
 * Parameters for tracking directory entry updates.  The hook function arg
 * parameter is one of these:
 */
