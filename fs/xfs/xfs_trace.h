...
DECLARE_EVENT_CLASS(xfs_dquot_class,
	...
	TP_fast_assign(
		...
		__entry->res_rtbcount = dqp->q_res_rtbcount;
		__entry->res_icount = dqp->q_res_icount;

		__entry->bcount = dqp->q_bcount;
		__entry->rtbcount = dqp->q_rtbcount;
		__entry->icount = dqp->q_icount;

		__entry->blk_hardlimit = dqp->q_blk_hardlimit;
		__entry->blk_softlimit = dqp->q_blk_softlimit;
		__entry->rtb_hardlimit = dqp->q_rtb_hardlimit;
		__entry->rtb_softlimit = dqp->q_rtb_softlimit;
		__entry->ino_hardlimit = dqp->q_ino_hardlimit;
		__entry->ino_softlimit = dqp->q_ino_softlimit;

		__entry->ina_bcount = dqp->q_ina_bcount;
		__entry->ina_rtbcount = dqp->q_ina_rtbcount;
		__entry->ina_icount = dqp->q_ina_icount;
	),
...
DEFINE_DEFER_EVENT(xfs_defer_relog);
DEFINE_DEFER_EVENT(xfs_defer_relog_done);
