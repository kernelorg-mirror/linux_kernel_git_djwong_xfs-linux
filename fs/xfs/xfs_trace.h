...
DECLARE_EVENT_CLASS(xfs_refcount_extent_class,
	...
	TP_printk("dev %d:%d opdev %d:%d agno 0x%x refcbno 0x%x fsbcount 0x%x refcount %u",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  MAJOR(__entry->opdev), MINOR(__entry->opdev),
		  __entry->agno,
		  __entry->startblock,
...
DECLARE_EVENT_CLASS(xfs_refcount_extent_at_class,
	...
	TP_printk("dev %d:%d opdev %d:%d agno 0x%x refcbno 0x%x fsbcount 0x%x refcount %u @ refcbno 0x%x",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  MAJOR(__entry->opdev), MINOR(__entry->opdev),
		  __entry->agno,
		  __entry->startblock,
...
DECLARE_EVENT_CLASS(xfs_refcount_double_extent_class,
	...
	TP_printk("dev %d:%d opdev %d:%d agno 0x%x refcbno 0x%x fsbcount 0x%x refcount %u -- "
		  "refcbno 0x%x fsbcount 0x%x refcount %u",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  MAJOR(__entry->opdev), MINOR(__entry->opdev),
		  __entry->agno,
...
DECLARE_EVENT_CLASS(xfs_refcount_double_extent_at_class,
	...
	TP_printk("dev %d:%d opdev %d:%d agno 0x%x refcbno 0x%x fsbcount 0x%x refcount %u -- "
		  "refcbno 0x%x fsbcount 0x%x refcount %u @ refcbno 0x%x",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  MAJOR(__entry->opdev), MINOR(__entry->opdev),
		  __entry->agno,
		  __entry->i1_startblock,
...
DECLARE_EVENT_CLASS(xfs_rtgroup_intents_class,
	...
	TP_fast_assign(
		...
		__entry->nr_intents = percpu_counter_sum(&rtg->rtg_intents.dr_count);
		__entry->caller_ip = caller_ip;
	),
