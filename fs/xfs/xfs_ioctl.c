	...
	struct xfs_swapext	*sxp)
{
	...
	fsr.file1_fd = sxp->sx_fdtmp;
	fsr.length = sxp->sx_length;
	fsr.flags = FILE_SWAP_RANGE_NONATOMIC | FILE_SWAP_RANGE_FILE2_FRESH |
		    FILE_SWAP_RANGE_FULL_FILES;
	fsr.file2_ino = sxp->sx_stat.bs_ino;
	fsr.file2_mtime = sxp->sx_stat.bs_mtime.tv_sec;
	fsr.file2_ctime = sxp->sx_stat.bs_ctime.tv_sec;
	fsr.file2_mtime_nsec = sxp->sx_stat.bs_mtime.tv_nsec;
	fsr.file2_ctime_nsec = sxp->sx_stat.bs_ctime.tv_nsec;
