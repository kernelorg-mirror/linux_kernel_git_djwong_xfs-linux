...
int xchk_setup_rtrefcountbt(struct xfs_scrub *sc, struct xfs_inode *ip);
#else
static inline int
...
static inline int
xchk_setup_rtrefcountbt(struct xfs_scrub *sc, struct xfs_inode *ip)
{
	return -ENOENT;
}
#endif
...
int xchk_setup_quotacheck(struct xfs_scrub *sc, struct xfs_inode *ip);
#else
static inline int
...
static inline int
xchk_setup_quotacheck(struct xfs_scrub *sc, struct xfs_inode *ip)
{
	return -ENOENT;
}
#endif
...
void xchk_rt_free(struct xfs_scrub *sc, struct xchk_rt *sr);
