	...
	bool			*inuse)
{
	 ...
	 * because we don't allow freed inodes to be recycled.  Recycling
	 * doesn't touch i_mode.
	 *
	 ...
	 *
	 * If the inode is anywhere in the reclaim mechanism, it's not ok to
	 * query i_mode because we could be recycling the inode.
	 *
