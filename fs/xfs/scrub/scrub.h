...
void xchk_xref_has_no_rt_owner(struct xfs_scrub *sc, xfs_rtblock_t rtbno,
		xfs_filblks_t len);
void xchk_xref_has_rt_owner(struct xfs_scrub *sc, xfs_rtblock_t rtbno,
		xfs_filblks_t len);
void xchk_xref_is_only_rt_owned_by(struct xfs_scrub *sc, xfs_rtblock_t rtbno,
		xfs_filblks_t len, const struct xfs_owner_info *oinfo);
void xchk_xref_is_rt_cow_staging(struct xfs_scrub *sc, xfs_rtblock_t bno,
		xfs_filblks_t len);
void xchk_xref_is_not_rt_shared(struct xfs_scrub *sc, xfs_rtblock_t bno,
		xfs_filblks_t len);
void xchk_xref_is_not_rt_cow_staging(struct xfs_scrub *sc, xfs_rtblock_t bno,
		xfs_filblks_t len);
#else
