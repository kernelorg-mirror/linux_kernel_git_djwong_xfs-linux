...
struct xrep_buf_scan {
	...
	/* Maximum number of addresses to walk. */
	xfs_daddr_t		max_daddrs;

	/* Increment the length by this step. */
...
xfs_daddr_t xrep_max_buf_len(struct xfs_mount *mp, xfs_extlen_t fsblocks);
