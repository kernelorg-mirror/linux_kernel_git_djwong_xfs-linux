...
void xbtree_afakeroot_init(struct xfs_mount *mp,
		struct xbtree_afakeroot *afake, xfs_agblock_t agbno);

/* Fake root overrides for AG-rooted btree types. */
void xbtree_afakeroot_set_root(struct xfs_btree_cur *cur,
		union xfs_btree_ptr *ptr, int inc);
void xbtree_afakeroot_adjust_blocks(struct xfs_btree_cur *cur, int nr);
void xbtree_afakeroot_init_ptr_from_cur(struct xfs_btree_cur *cur,
		union xfs_btree_ptr *ptr);
