...

{
	...
	{ /* BNO root block */
		...
		.bc_ops = xfs_has_crc(mp) ? &xfs_crc_bnobt_ops : &xfs_bnobt_ops,
		.need_init = true
	},
	{ /* CNT root block */
		...
		.work = &xfs_bnoroot_init,
		.bc_ops = xfs_has_crc(mp) ? &xfs_crc_cntbt_ops : &xfs_cntbt_ops,
		.need_init = true
	},
	{ /* INO root block */
		...
		.bc_ops = xfs_has_crc(mp) ? &xfs_crc_inobt_ops : &xfs_inobt_ops,
		.need_init = true
	},
	{ /* FINO root block */
