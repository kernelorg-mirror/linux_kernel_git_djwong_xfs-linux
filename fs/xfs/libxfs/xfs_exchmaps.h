...
#define XFS_EXCHMAPS_INO2_SHORTFORM	(1ULL << 63)

#define XFS_EXCHMAPS_INTERNAL_FLAGS	(XFS_EXCHMAPS_INO2_SHORTFORM)
...
unsigned int xfs_exchmaps_reflink_prep(const struct xfs_exchmaps_req *req);
