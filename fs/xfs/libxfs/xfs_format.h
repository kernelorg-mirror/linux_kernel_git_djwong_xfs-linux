 ...
 */
#define XFS_INO_BIGTIME_MAX	((-1ULL / NSEC_PER_SEC) - XFS_INO_BIGTIME_EPOCH)
 ...
 */
#define XFS_DQ_TIMEOUT_MIN	(1)

/*
 * Largest possible quota expiration with traditional timestamps, which is
 * Feb  7 06:28:15 UTC 2106.
 */
#define XFS_DQ_TIMEOUT_MAX	(4294967295)

/* Quota grace periods. */
#define XFS_DQ_GRACE_MIN	(0)
#define XFS_DQ_GRACE_MAX	(4294967295)
