...
/*
 * Decide if this filesystem can use atomic extent swapping.  The atomic swap
 * log intent items depend on the block mapping log intent items introduced
 * with reflink and rmap.
 */
...
/* Are there dirty atomic swap intent items in the log? */
