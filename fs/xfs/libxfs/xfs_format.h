...
/*
 * Log contains xattr update log intent items which are not otherwise protected
 * by an INCOMPAT/RO_COMPAT feature flag.
 */
 ...
 */
#define XFS_SB_FEAT_INCOMPAT_LOG_EXCHMAPS	(1U << 31)
