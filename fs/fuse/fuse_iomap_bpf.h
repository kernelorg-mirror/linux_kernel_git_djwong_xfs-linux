...
struct fuse_iomap_bpf_ops {
	 ...
	 * details.
	 */
	int (*iomap_begin)(uint64_t nodeid, uint64_t pos, uint64_t count,
			   uint32_t opflags,
	 ...
	 * details.
	 */
	int (*iomap_end)(uint64_t nodeid, uint64_t pos, uint64_t count,
	 ...
	 * details.
	 */
	int (*iomap_ioend)(uint64_t nodeid, uint64_t pos, int64_t written,
